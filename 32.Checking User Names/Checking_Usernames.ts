let current_users: string[] = ["ayesha", "anaya", "habiba", "sarah", "sana"];
let new_users: string[] = ["ayesha", "anaya", "habiba", "sarah", "sana"];

for (let new_username of new_users) {
    // Convert both usernames to lowercase for case-insensitive comparison
    let isUsernameTaken: boolean = current_users.some(username => username.toLowerCase() === new_username.toLowerCase());
